...
echo "  xcodebuild build -project ios-app/MeshLog.xcodeproj -scheme MeshLogAustria"
echo "  xcodebuild test  -project ios-app/MeshLog.xcodeproj -scheme MeshLogAustria"
